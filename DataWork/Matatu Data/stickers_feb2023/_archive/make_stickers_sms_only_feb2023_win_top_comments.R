...
blank_sticker_psv <- brick(file.path(matatu_data_dir, "Stickers", "stickers_feb2023_win_sms_top_comments", "sticker_sms_only_blank_psv_no.png"))
blank_sticker_reg <- brick(file.path(matatu_data_dir, "Stickers", "stickers_feb2023_win_sms_top_comments", "sticker_sms_only_blank_reg_no.png"))
...
for(i in 1:nrow(veh_reg_no_df)){ # 1:nrow(veh_reg_no_df)
  print(i)
  ...
  ## Plot
  png(file.path(matatu_data_dir, "Stickers", "stickers_feb2023_win_sms_top_comments", "stickers_sms_only_reg_no", 
                paste0(reg_no_i, ".png")),
      10240,10240)
...
# # Append images ----------------------------------------------------------------
## Reg No
images_reg = list.files(file.path(matatu_data_dir, "Stickers", "stickers_feb2023_win_sms_top_comments", "stickers_sms_only_reg_no"),
                        full.names = TRUE,
                        pattern = '.png')

image_write(image_read(images_reg),
            format = "pdf",
            file.path(matatu_data_dir, "Stickers", "stickers_feb2023_win_sms_top_comments", "stickers_sms_only_reg_no.pdf"))
# 
# ## PSV No
